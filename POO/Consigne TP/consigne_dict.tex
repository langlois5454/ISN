...
\begin{verbatim}
       ...
       emprunts : "emprunt\_1","emprunt\_2","emprunt\_4"
\end{verbatim}
}
...
\item Écrivez une fonction \texttt{lister\_pret\_en\_retard(dict\_emprunts)} qui renvoie la liste des identifiants des emprunts en retard. La liste des emprunts est donnée par \texttt{dict\_emprunts}.
